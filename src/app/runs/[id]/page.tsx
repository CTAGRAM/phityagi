            ...
            {run.status === 'completed' ? (
              <>
                ...
                <p className="text-sm text-neutral-400 max-w-md mx-auto mb-8 leading-relaxed">
                  ...
                  You can now export the compiled package as Markdown or raw JSON metadata for your archives.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <button 
                    ...
                    className="px-6 py-2.5 rounded-md bg-white text-black font-semibold text-sm hover:bg-neutral-200 transition-colors flex items-center gap-2"
                  >
                  ...
                  <button 
                    ...
                    className="px-6 py-2.5 rounded-md bg-black text-white border border-neutral-700 font-medium text-sm hover:bg-neutral-900 transition-colors flex items-center gap-2"
                  >
                    {'{ }'} Raw JSON Data
                  </button>
                </div>
